...
exports['ios-Default-2732h@2x'] = {
  type: 'splash',
  path: path.join(':assets:', 'iphone', 'Default@2x~universal~anyany.png'),
  localePath: path.join(':i18n:', ':locale:', 'Default@2x~universal~anyany.png'),
  width: 2732,
  height: 2732,
  platforms: ['iphone'],
  sdkVersion: '>=6.3.0'
};
exports['ios-Default-2208h@3x'] = {
  type: 'splash',
  path: path.join(':assets:', 'iphone', 'Default@3x~universal~anyany.png'),
  localePath: path.join(':i18n:', ':locale:', 'Default@3x~universal~anyany.png'),
  width: 2208,
  height: 2208,
  platforms: ['iphone'],
  sdkVersion: '>=6.3.0'
